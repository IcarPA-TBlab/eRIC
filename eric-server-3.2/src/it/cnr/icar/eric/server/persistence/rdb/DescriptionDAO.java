...
class DescriptionDAO extends InternationalStringDAO {
    ...
    InternationalStringType getDescriptionByParent(String parentId)
        throws RegistryException {
        return (super.getInternationalStringByParent(parentId));
    }
    ...
    Object createObject() throws JAXBException {
        InternationalStringType obj = bu.rimFac.createInternationalStringType();
