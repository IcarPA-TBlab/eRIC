 ...
 * @author  Tony Graham
 */
public class ServiceInvocationInfoComparator implements Comparator<Object> {
    static final Comparator<Object> identifiableComparator = new IdentifiableComparator();
