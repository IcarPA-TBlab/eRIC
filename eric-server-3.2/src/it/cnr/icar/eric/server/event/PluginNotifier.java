...
import it.cnr.icar.eric.common.spi.NotificationListener;
    ...
    protected void sendNotification(ServerRequestContext context, NotifyActionType notifyAction, 
        ...
        try {
            ...
            if (!(obj instanceof NotificationListener)) {
                throw new RegistryException(CommonResourceBundle.getInstance().getString("message.unexpectedObjectType",new Object[] {"it.cnr.icar.eric.common.NotificationListener"}));
            }
