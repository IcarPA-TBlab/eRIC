...
import it.cnr.icar.eric.common.exceptions.DuplicateIdException;
...
public class Utility {
    ...
    private it.cnr.icar.eric.common.UUIDFactory uf = it.cnr.icar.eric.common.UUIDFactory.getInstance();
...
//        msg.saveChanges();
     ...
     */
    @SuppressWarnings("unused")
	private void checkId(List<String> ids, HashMap<String, String> idMap, RegistryObjectType ro)
	throws RegistryException {
        try {
            String id = ro.getId();
            ...
            if ((id == null) || !id.startsWith("urn:uuid:")) {
                ...
                it.cnr.icar.eric.common.UUID uuid = uf.newUUID();
