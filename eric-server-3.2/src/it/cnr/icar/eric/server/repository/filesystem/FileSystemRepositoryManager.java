 ...
 * ====================================================================
 */
package it.cnr.icar.eric.server.repository.filesystem;
...
public class FileSystemRepositoryManager extends AbstractRepositoryManager {
    ...
    protected FileSystemRepositoryManager() {
        repositoryRoot =
	    RegistryProperties.getInstance().getProperty("eric.repository.home");
    }
    ...
    */
    public List<String> itemsExist(List<String> ids) throws RegistryException {
        List<String> notExistIds = new java.util.ArrayList<String>();
    ...
    */
    ...
    public void delete(it.cnr.icar.eric.server.repository.RepositoryItemKey key) throws RegistryException {
        throw new RegistryException(ServerResourceBundle.getInstance().getString("message.unimplemented"));
    }
    
    public RepositoryItem getRepositoryItem(it.cnr.icar.eric.server.repository.RepositoryItemKey key) throws RegistryException {
        throw new RegistryException(ServerResourceBundle.getInstance().getString("message.unimplemented"));
    }
