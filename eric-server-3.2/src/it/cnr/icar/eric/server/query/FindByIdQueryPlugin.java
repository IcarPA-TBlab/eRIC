...
public class FindByIdQueryPlugin extends AbstractQueryPlugin {
    ...
    public void processRequest(RequestContext context) throws RegistryException {
        ...
        ArrayList<JAXBElement<RegistryObjectType>> results = new ArrayList<JAXBElement<RegistryObjectType>>();
        RegistryObjectType ebRegistryObjectType = ServerCache.getInstance().getRegistryObject((ServerRequestContext)context, objectId, tableName);
        // wrap as element
        JAXBElement<RegistryObjectType> ebRegistryObject = BindingUtility.getInstance().rimFac.createRegistryObject(ebRegistryObjectType);
        
        results.add(ebRegistryObject);
