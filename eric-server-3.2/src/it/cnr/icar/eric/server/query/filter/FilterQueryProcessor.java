...
public abstract class FilterQueryProcessor {
    ...
    private ArrayList<TableNameAlias> tableNameAliases = new ArrayList<TableNameAlias>();
    ...
    private String buildSelectStatement() throws RegistryException {
        ...
        if (parentQueryProcessor == null) {
            ...
            String tableName = (tableNameAliases.get(0)).tableName;
            ...
            for (int i=1; i<tableNameAliases.size(); i++) {
                tableName = (tableNameAliases.get(i)).tableName;
                String otherAlias = (tableNameAliases.get(i)).alias;
