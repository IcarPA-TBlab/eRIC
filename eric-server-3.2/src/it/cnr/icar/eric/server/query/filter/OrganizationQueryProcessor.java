...
class OrganizationQueryProcessor extends RegistryObjectQueryProcessor {
    ...
    protected String processFilters() throws RegistryException {
        ...
        List<FilterType> addressFilters = ((OrganizationQueryType)filterQuery).getAddressFilter();
        ...
        List<FilterType> phoneFilters = ((OrganizationQueryType)filterQuery).getTelephoneNumberFilter();
        ...
        List<FilterType> emailFilters = ((OrganizationQueryType)filterQuery).getEmailAddressFilter();
    ...
    protected String processSubQueries() throws RegistryException {
        ...
        List<OrganizationQueryType> childQueries = ((OrganizationQueryType)filterQuery).getChildOrganizationQuery();
         
        if (childQueries != null) {
         
            Iterator<OrganizationQueryType> iter = childQueries.iterator();
            while (iter.hasNext()) {
