...
class ServiceBindingQueryProcessor extends RegistryObjectQueryProcessor {
    ...
    protected String processSubQueries() throws RegistryException {
        ...
        List<SpecificationLinkQueryType> specLinkQueries = ((ServiceBindingQueryType)filterQuery).getSpecificationLinkQuery();
         
        if (specLinkQueries != null) {
         
            Iterator<SpecificationLinkQueryType> iter = specLinkQueries.iterator();
            while (iter.hasNext()) {
