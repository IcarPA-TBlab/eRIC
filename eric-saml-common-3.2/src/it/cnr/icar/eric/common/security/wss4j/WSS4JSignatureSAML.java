...
public class WSS4JSignatureSAML extends WSSecSignature {

    private static org.apache.commons.logging.Log log = 
        org.apache.commons.logging.LogFactory.getLog(WSS4JSignatureSAML.class);
     ...
     * Constructor.
     */
    public WSS4JSignatureSAML(WSSConfig config) {
        super(config);
        doDebug = log.isDebugEnabled();
    }
