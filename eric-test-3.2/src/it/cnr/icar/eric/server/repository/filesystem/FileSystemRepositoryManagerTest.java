...
import it.cnr.icar.eric.server.repository.RepositoryManagerTest;
...
public class FileSystemRepositoryManagerTest extends RepositoryManagerTest {
    ...
    static {
        RegistryProperties.getInstance().put("eric.server.repository.RepositoryManagerFactory.repositoryManagerClass",
            "it.cnr.eric.server.repository.filesystem.FileSystemRepositoryManager");
    };
