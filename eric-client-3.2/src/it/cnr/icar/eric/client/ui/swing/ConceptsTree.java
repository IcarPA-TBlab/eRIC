...
public class ConceptsTree extends JTree implements PropertyChangeListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4053112612634461571L;
     ...
     * @return DOCUMENT ME!
     */
    public ArrayList<Concept> getSelectedConcepts() {
     ...
     * @return DOCUMENT ME!
     */
    public ArrayList<RegistryObject> getSelectedClassificationSchemes() {
     ...
     * @return DOCUMENT ME!
     */
    public ArrayList<RegistryObject> getSelectedObjects() {
        ArrayList<RegistryObject> objects = new ArrayList<RegistryObject>();
    ...
    public class ConceptsTreeCellRenderer extends JLabel
		 ...
		 * 
		 */
		private static final long serialVersionUID = -2220122288265444597L;
