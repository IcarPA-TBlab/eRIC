...
public class ConnectionImpl implements Connection {
    ...
    private static final it.cnr.icar.eric.client.xml.registry.util.SecurityUtil su =
        it.cnr.icar.eric.client.xml.registry.util.SecurityUtil.getInstance();
    ...
    ConnectionImpl(ConnectionFactoryImpl factory) throws JAXRException {
        ...
        localCallMode = Boolean.valueOf(props.getProperty(
                "it.cnr.icar.eric.client.xml.registry.localCall", "false")).booleanValue();
