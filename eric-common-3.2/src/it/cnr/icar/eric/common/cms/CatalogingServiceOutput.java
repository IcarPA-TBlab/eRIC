...
public class CatalogingServiceOutput extends CMSOutput {
    ...
    private HashMap<String,Object> idToRepositoryItemMap = null;
    
    @SuppressWarnings("unused")
	private CatalogingServiceOutput() {}
    
    public CatalogingServiceOutput(Set<?> registryObjects, HashMap<String, Object> idToRepositoryItemMap) {
        this.registryObjects = registryObjects;
        this.idToRepositoryItemMap = idToRepositoryItemMap;
    }
    
    public HashMap<String, Object> getRepositoryItemMap() {
