...
public class EbXMLRegistrySOAPService_Impl extends com.sun.xml.rpc.client.BasicService implements EbXMLRegistrySOAPService {
    ...
    private static final Class<QueryManagerPortType> queryManagerPortType_PortClass = it.cnr.icar.eric.common.jaxrpc.registry.client.QueryManagerPortType.class;
    private static final QName ns1_LifeCycleManagerPort_QNAME = new QName("urn:your:urn:goes:here", "LifeCycleManagerPort");
    private static final Class<LifeCycleManagerPortType> lifeCycleManagerPortType_PortClass = it.cnr.icar.eric.common.jaxrpc.registry.client.LifeCycleManagerPortType.class;
    ...
    public EbXMLRegistrySOAPService_Impl() {
        super(serviceName, new QName[] {
            ...
            new it.cnr.icar.eric.common.jaxrpc.registry.client.EbXMLRegistrySOAPService_SerializerRegistry().getRegistry());
        
    }
    
    public java.rmi.Remote getPort(QName portName, @SuppressWarnings("rawtypes") Class serviceDefInterface) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public java.rmi.Remote getPort(@SuppressWarnings("rawtypes") Class serviceDefInterface) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public it.cnr.icar.eric.common.jaxrpc.registry.client.QueryManagerPortType getQueryManagerPort() {
        ...
        it.cnr.icar.eric.common.jaxrpc.registry.client.QueryManagerPortType_Stub stub = new it.cnr.icar.eric.common.jaxrpc.registry.client.QueryManagerPortType_Stub(handlerChain);
        try {
    ...
    public it.cnr.icar.eric.common.jaxrpc.registry.client.LifeCycleManagerPortType getLifeCycleManagerPort() {
        String[] roles = new String[] {};
        HandlerChainImpl handlerChain = new HandlerChainImpl(getHandlerRegistry().getHandlerChain(ns1_LifeCycleManagerPort_QNAME));
        handlerChain.setRoles(roles);
        it.cnr.icar.eric.common.jaxrpc.registry.client.LifeCycleManagerPortType_Stub stub = new it.cnr.icar.eric.common.jaxrpc.registry.client.LifeCycleManagerPortType_Stub(handlerChain);
        try {
            stub._initialize(super.internalTypeRegistry);
        } catch (JAXRPCException e) {
            throw e;
