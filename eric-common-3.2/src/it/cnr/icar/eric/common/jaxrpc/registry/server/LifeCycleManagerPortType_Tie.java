...
public class LifeCycleManagerPortType_Tie
    ...
    public LifeCycleManagerPortType_Tie() throws Exception {
        super(new it.cnr.icar.eric.common.jaxrpc.registry.server.EbXMLRegistrySOAPService_SerializerRegistry().getRegistry());
    ...
    private void invoke_approveObjects(StreamingHandlerState state) throws Exception {
        ...
        try {
            javax.xml.soap.SOAPElement partRegistryResponse = ((it.cnr.icar.eric.common.jaxrpc.registry.server.LifeCycleManagerPortType) getTarget()).approveObjects(mySOAPElement);
    ...
    private void invoke_undeprecateObjects(StreamingHandlerState state) throws Exception {
        ...
        try {
            javax.xml.soap.SOAPElement partRegistryResponse = ((it.cnr.icar.eric.common.jaxrpc.registry.server.LifeCycleManagerPortType) getTarget()).undeprecateObjects(mySOAPElement);
    ...
    private void invoke_deprecateObjects(StreamingHandlerState state) throws Exception {
        ...
        try {
            javax.xml.soap.SOAPElement partRegistryResponse = ((it.cnr.icar.eric.common.jaxrpc.registry.server.LifeCycleManagerPortType) getTarget()).deprecateObjects(mySOAPElement);
    ...
    private void invoke_removeObjects(StreamingHandlerState state) throws Exception {
        ...
        try {
            javax.xml.soap.SOAPElement partRegistryResponse = ((it.cnr.icar.eric.common.jaxrpc.registry.server.LifeCycleManagerPortType) getTarget()).removeObjects(mySOAPElement);
    ...
    private void invoke_updateObjects(StreamingHandlerState state) throws Exception {
        ...
        try {
            javax.xml.soap.SOAPElement partUpdateObjectsRequest = ((it.cnr.icar.eric.common.jaxrpc.registry.server.LifeCycleManagerPortType) getTarget()).updateObjects(mySOAPElement);
    ...
    private void invoke_submitObjects(StreamingHandlerState state) throws Exception {
        ...
        try {
            javax.xml.soap.SOAPElement partRegistryResponse = ((it.cnr.icar.eric.common.jaxrpc.registry.server.LifeCycleManagerPortType) getTarget()).submitObjects(mySOAPElement);
    ...
    private Method internalGetMethodForOpcode(int opcode) throws ClassNotFoundException, NoSuchMethodException {
        ...
        switch(opcode) {
            case approveObjects_OPCODE:
                {
                    ...
                    theMethod = (it.cnr.icar.eric.common.jaxrpc.registry.server.LifeCycleManagerPortType.class).getMethod("approveObjects", carray);
                }
                break;
            ...
            case undeprecateObjects_OPCODE:
                {
                    Class<?>[] carray = { javax.xml.soap.SOAPElement.class };
                    theMethod = (it.cnr.icar.eric.common.jaxrpc.registry.server.LifeCycleManagerPortType.class).getMethod("undeprecateObjects", carray);
                }
                break;
            ...
            case deprecateObjects_OPCODE:
                {
                    Class<?>[] carray = { javax.xml.soap.SOAPElement.class };
                    theMethod = (it.cnr.icar.eric.common.jaxrpc.registry.server.LifeCycleManagerPortType.class).getMethod("deprecateObjects", carray);
                }
                break;
            ...
            case removeObjects_OPCODE:
                {
                    Class<?>[] carray = { javax.xml.soap.SOAPElement.class };
                    theMethod = (it.cnr.icar.eric.common.jaxrpc.registry.server.LifeCycleManagerPortType.class).getMethod("removeObjects", carray);
                }
                break;
            ...
            case updateObjects_OPCODE:
                {
                    Class<?>[] carray = { javax.xml.soap.SOAPElement.class };
                    theMethod = (it.cnr.icar.eric.common.jaxrpc.registry.server.LifeCycleManagerPortType.class).getMethod("updateObjects", carray);
                }
                break;
            ...
            case submitObjects_OPCODE:
                {
                    Class<?>[] carray = { javax.xml.soap.SOAPElement.class };
                    theMethod = (it.cnr.icar.eric.common.jaxrpc.registry.server.LifeCycleManagerPortType.class).getMethod("submitObjects", carray);
                }
                break;
    ...
    @SuppressWarnings("unused")
	private static final javax.xml.namespace.QName portName = new QName("urn:your:urn:goes:here", "LifeCycleManagerPort");
    private static final int approveObjects_OPCODE = 0;
    private static final int undeprecateObjects_OPCODE = 1;
    private static final int deprecateObjects_OPCODE = 2;
    private static final int removeObjects_OPCODE = 3;
    private static final int updateObjects_OPCODE = 4;
    private static final int submitObjects_OPCODE = 5;
    private static final javax.xml.namespace.QName ns3_approveObjects_ApproveObjectsRequest_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:lcm:3.0", "ApproveObjectsRequest");
    private static final javax.xml.namespace.QName ns1_AdhocQueryRequest_TYPE_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0", "AdhocQueryRequest");
    private CombinedSerializer ns1_ns1_AdhocQueryRequest_TYPE_QNAME_Serializer;
    private static final javax.xml.namespace.QName ns2_approveObjects_RegistryResponse_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:rs:3.0", "RegistryResponse");
    private static final javax.xml.namespace.QName ns2_RegistryResponseType_TYPE_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:rs:3.0", "RegistryResponseType");
    private CombinedSerializer ns2_ns2_RegistryResponseType_TYPE_QNAME_Serializer;
    private static final javax.xml.namespace.QName ns3_undeprecateObjects_UndeprecateObjectsRequest_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:lcm:3.0", "UndeprecateObjectsRequest");
    private static final javax.xml.namespace.QName ns2_undeprecateObjects_RegistryResponse_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:rs:3.0", "RegistryResponse");
    private static final javax.xml.namespace.QName ns3_deprecateObjects_DeprecateObjectsRequest_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:lcm:3.0", "DeprecateObjectsRequest");
    private static final javax.xml.namespace.QName ns2_deprecateObjects_RegistryResponse_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:rs:3.0", "RegistryResponse");
    private static final javax.xml.namespace.QName ns3_removeObjects_RemoveObjectsRequest_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:lcm:3.0", "RemoveObjectsRequest");
    private static final javax.xml.namespace.QName ns2_removeObjects_RegistryResponse_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:rs:3.0", "RegistryResponse");
    private static final javax.xml.namespace.QName ns3_updateObjects_UpdateObjectsRequest_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:lcm:3.0", "UpdateObjectsRequest");
    private static final javax.xml.namespace.QName ns3_UpdateObjectsRequest_TYPE_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:lcm:3.0", "UpdateObjectsRequest");
    private CombinedSerializer ns3_ns3_UpdateObjectsRequest_TYPE_QNAME_Serializer;
    private static final javax.xml.namespace.QName ns3_submitObjects_SubmitObjectsRequest_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:lcm:3.0", "SubmitObjectsRequest");
    private static final javax.xml.namespace.QName ns3_SubmitObjectsRequest_TYPE_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:lcm:3.0", "SubmitObjectsRequest");
    private CombinedSerializer ns3_ns3_SubmitObjectsRequest_TYPE_QNAME_Serializer;
    private static final javax.xml.namespace.QName ns2_submitObjects_RegistryResponse_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:rs:3.0", "RegistryResponse");
