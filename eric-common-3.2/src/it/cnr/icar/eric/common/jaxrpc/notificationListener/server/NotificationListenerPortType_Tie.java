...
public class NotificationListenerPortType_Tie
    ...
    public NotificationListenerPortType_Tie() throws Exception {
        super(new it.cnr.icar.eric.common.jaxrpc.notificationListener.server.NotificationListenerSOAPService_SerializerRegistry().getRegistry());
    ...
    private void invoke_onObjectRefsNotification(StreamingHandlerState state) throws Exception {
        ...
        try {
            ((it.cnr.icar.eric.common.jaxrpc.notificationListener.server.NotificationListenerPortType) getTarget()).onObjectRefsNotification(mySOAPElement);
    ...
    private void invoke_onObjectsNotification(StreamingHandlerState state) throws Exception {
        ...
        try {
            ((it.cnr.icar.eric.common.jaxrpc.notificationListener.server.NotificationListenerPortType) getTarget()).onObjectsNotification(mySOAPElement);
    ...
    private Method internalGetMethodForOpcode(int opcode) throws ClassNotFoundException, NoSuchMethodException {
        ...
        switch(opcode) {
            case onObjectRefsNotification_OPCODE:
                {
                    ...
                    theMethod = (it.cnr.icar.eric.common.jaxrpc.notificationListener.server.NotificationListenerPortType.class).getMethod("onObjectRefsNotification", carray);
                }
                break;
            ...
            case onObjectsNotification_OPCODE:
                {
                    Class<?>[] carray = { javax.xml.soap.SOAPElement.class };
                    theMethod = (it.cnr.icar.eric.common.jaxrpc.notificationListener.server.NotificationListenerPortType.class).getMethod("onObjectsNotification", carray);
                }
                break;
