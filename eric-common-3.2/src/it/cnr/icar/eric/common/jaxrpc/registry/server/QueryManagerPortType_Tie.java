...
public class QueryManagerPortType_Tie
    ...
    private void invoke_submitAdhocQuery(StreamingHandlerState state) throws Exception {
        ...
        try {
            javax.xml.soap.SOAPElement partAdhocQueryResponse = ((it.cnr.icar.eric.common.jaxrpc.registry.server.QueryManagerPortType) getTarget()).submitAdhocQuery(mySOAPElement);
            ...
            case submitAdhocQuery_OPCODE:
                {
                    ...
                    theMethod = (it.cnr.icar.eric.common.jaxrpc.registry.server.QueryManagerPortType.class).getMethod("submitAdhocQuery", carray);
                }
                break;
    ...
    @SuppressWarnings("unused")
	private static final javax.xml.namespace.QName portName = new QName("urn:your:urn:goes:here", "QueryManagerPort");
    private static final int submitAdhocQuery_OPCODE = 0;
    private static final javax.xml.namespace.QName ns1_submitAdhocQuery_AdhocQueryRequest_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0", "AdhocQueryRequest");
    ...
    private static final javax.xml.namespace.QName ns1_submitAdhocQuery_AdhocQueryResponse_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0", "AdhocQueryResponse");
    private static final javax.xml.namespace.QName ns1_AdhocQueryResponse_TYPE_QNAME = new QName("urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0", "AdhocQueryResponse");
