...
import static it.cnr.icar.eric.common.security.KeyTool.Command.*;
import static it.cnr.icar.eric.common.security.KeyTool.Option.*;
...
public final class KeyTool {
    ...
    // If you're calling KeyTool7.main() directly in your own Java program,
    ...
    public void run(String[] args, PrintStream out) throws Exception {
        try {
            ...
            */
        	// xxx pa 120220 no system.exit() just throw exception! 
			throw e;
        } finally {
        ...
        throws Exception
    {
        ...
        /*
         *  JDK6 path
         *  encodeAndSign() has only one parameter and need a step between with a X500Signer() 
         */
...
//        request.encodeAndSign(x500signer);
        ...
        /*
         *  JDK7 path
         *  encodeAndSign() has two parameter and does not need the step between with a X500Signer() 
         */
    ...
    public static Collection<? extends CRL> loadCRLs(String src) throws Exception {
	    ...
	    /*
	     *  JDK6 path
	     *  replaces the out-commented else branch which worked in JDK7
	     *  need else branch return to satisfy the interface 
	     */

        } else {
        	System.out.println("   KeyTool.loadCRLs() reached wrong branch.");
        	List<CRL> dummy = null;
        	return dummy;
        }
...
//        }
    ...
    private void doPrintCertReq(InputStream in, PrintStream out)
            throws Exception {
    	/**
    	 * deactivate unneeded doPrintCertReq 
    	 */
//        BufferedReader reader = new BufferedReader(new InputStreamReader(in));
//        StringBuffer sb = new StringBuffer();
