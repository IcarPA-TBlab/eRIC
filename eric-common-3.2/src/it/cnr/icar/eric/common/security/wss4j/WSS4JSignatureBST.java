 ...
 */
public class WSS4JSignatureBST extends WSSecSignatureBase {

    private static org.apache.commons.logging.Log log = 
        org.apache.commons.logging.LogFactory.getLog(WSS4JSignatureBST.class);
    ...
    public WSS4JSignatureBST() {
        super();
        init();
    }
    
    public WSS4JSignatureBST(WSSConfig config) {
        super(config);
        init();
    }
